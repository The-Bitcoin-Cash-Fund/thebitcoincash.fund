    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <form action="https://facebook.us17.list-manage.com/subscribe/post" method="POST" class="form-inline">
          ...
          <input type="submit" class="btn btn-default btn-lg subscribe-btn" name="submit" value="Subscribe">
        </form>
      </div>
    </div>
  </div>
...
<!-- Footer -->
<a href="#" role="button" class="btn footer-scrollTop">Back to Top</a>
    ...
    <div class="row">
      <div class="footer-col footer-explore">
        ...
        <ul class="footer-linkList">
          ...
          <li><a href="<?= $config['base_url']; ?>volunteer/">Volunteer</a></li>
      ...
      <div class="footer-col footer-info">
        ...
        <ul class="footer-linkList">
          ...
          <li><a href="<?= $config['base_url']; ?>faqs/">FAQs</a></li>
      ...
      <div class="footer-col footer-sns">
        ...
        <ul class="contact-snsList">
          ...
          <li><a href="https://chat.thebitcoincash.fund" target="_blank"><img src="<?= $config['svg_dir']; ?>sns-bcf-chat.svg" alt="Facebook" class="contact-snsImg contact-snsImg-bcfChat"></a></li>
